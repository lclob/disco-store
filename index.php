...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light w-100">
    <a id="logo" class="navbar-brand" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="35" height="35"
        fill="currentColor" class="bi bi-disc" viewBox="0 0 16 16">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle active" href="index.php?sec=discos" role="button" data-bs-toggle="dropdown"
            aria-expanded="false">
            Discos
          </a>
